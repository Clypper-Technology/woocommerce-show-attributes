...
function add_settings( $settings, $current_section ) {
    if ( 'wc_show_attributes' == $current_section ) {
        return show_attributes_get_all_settings();
 ...
 * @since 1.6.1
 */
function show_attributes_get_all_settings(): array {
    ...
    return array(
        ...
        array(
            ...
            'id' => 'show_attributes_remove_semicolon',
            'default' => 'no',
            'type' => 'checkbox',
        ...
        array(
            ...
            'id' => 'show_attributes_dimensions_product',
            'default' => 'no',
            'type' => 'checkbox',
        ...
        array(
            ...
            'id' => 'show_attributes_weight_cart',
            'default' => 'no',
            'type' => 'checkbox',
        ...
        array(
            ...
            'id' => 'show_attributes_dimensions_cart',
            'default' => 'no',
            'type' => 'checkbox',
